    ...
    <div className="mx-auto w-full max-w-4xl px-6 pt-24 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <Tabs defaultValue="appearance" className="w-full">
        <TabsList className="mb-8 p-1 bg-zinc-100 dark:bg-zinc-900/50 rounded-xl border border-zinc-200 dark:border-zinc-800">
          <TabsTrigger
            value="appearance"
            className="gap-2 px-4 py-2 rounded-lg data-active:bg-white dark:data-active:bg-zinc-800 data-active:shadow-sm transition-all"
          >
        ...
        <TabsContent value="appearance" className="space-y-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950/50 backdrop-blur-sm">
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Settings related to how MealPlanner looks. Use the theme toggle in
              ...
              {[
                {
                  ...
                  desc: "Get reminded about your upcoming planned meals.",
                },
                {
                  id: "recipeUpdates",
                  label: "Recipe Updates",
                  desc: "Alerts when recipes you follow are updated.",
                },
                {
                  id: "communityActivity",
                  label: "Community Activity",
                  desc: "Notify me of likes, comments, and new followers.",
                },
                {
                  id: "shoppingListAlerts",
                  label: "Shopping List Alerts",
                  desc: "Reminders for items on your shopping list.",
                },
              ].map((notif) => (
                <div
                  key={notif.id}
                  className="flex items-center justify-between p-4 rounded-xl border border-zinc-100 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900/40 transition-colors"
                >
                  <div>
                  ...
                  <Switch
                    checked={
                      settings?.notifications[
                        notif.id as keyof typeof settings.notifications
                      ]
                    }
                    onCheckedChange={(val) =>
                      setSettings((s) =>
                        s
                          ? {
                              ...
                              notifications: {
                                ...s.notifications,
                                [notif.id as keyof typeof s.notifications]: val,
                              },
                            }
                          : null,
                      )
        ...
        <TabsContent value="privacy" className="space-y-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950/50 backdrop-blur-sm">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              Control who can interact with your profile and recipes.
            </p>
            ...
            <div className="mt-8 space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    Determine who can see your public profile.
                  </p>
                </div>
                <Select
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800">
                <div>
                  <p className="font-semibold text-zinc-900 dark:text-white">
                    Recipe Default Visibility
                  </p>
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    Sets the initial visibility for newly created recipes.
                  </p>
                </div>
                <Select
      ...
      <div className="mt-12 flex items-center justify-between p-6 rounded-2xl bg-zinc-900 dark:bg-primary shadow-xl shadow-primary/10">
        <div className="hidden sm:block">
          ...
          <p className="text-zinc-400 dark:text-primary-foreground/70 text-sm">
