  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-6 pt-24 pb-20 animate-page-in">
      ...
      <div className="relative mb-24">
        ...
        <div className="h-64 sm:h-80 w-full rounded-[2.5rem] bg-linear-to-br from-emerald-400/20 to-blue-500/20 dark:from-emerald-500/10 dark:to-blue-600/10 border border-zinc-200 dark:border-zinc-800 relative shadow-inner overflow-hidden">
      ...
      <div className="grid lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-1 space-y-8">
              ...
              <div className="space-y-4">
                 <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400">
                    ...
                    <div className="text-sm">
                       <p className="font-semibold text-zinc-900 dark:text-white">{L("MealPlannerAPI", "MemberSince")}</p>
                       <p>April 2024</p>
                    </div>
                 </div>
                 <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400">
                    ...
                    <div className="text-sm">
                       <p className="font-semibold text-zinc-900 dark:text-white">{L("MealPlannerAPI", "CookingLevel")}</p>
          ...
          <div className="p-6 rounded-3xl bg-linear-to-br from-emerald-500 to-teal-600 text-white shadow-xl shadow-emerald-500/20">
             <h3 className="font-bold text-lg mb-2">{L("MealPlannerAPI", "CulinaryJourney")}</h3>
             <p className="text-emerald-50/80 text-sm leading-relaxed mb-4">
                {L("MealPlannerAPI", "CulinaryJourneyDesc")}
             </p>
             <Button variant="secondary" className="w-full bg-white text-emerald-600 hover:bg-emerald-50 transition-colors rounded-xl font-bold">
            ...
            {loading ? (
              ...
              myRecipes.length > 0 ? (
                ...
                <div className="col-span-full py-20 text-center bg-zinc-50/50 dark:bg-zinc-900/50 rounded-[2.5rem] border-2 border-dashed border-zinc-200 dark:border-zinc-800">
                   ...
                   <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">{L("MealPlannerAPI", "NoRecipesYet")}</h3>
                   <p className="text-zinc-500 mb-6">{L("MealPlannerAPI", "NoRecipesYetDesc")}</p>
                   <Button onClick={() => router.push("/recipe/add")} className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl px-8 font-bold transition-all shadow-lg shadow-emerald-500/20 active:scale-95">
              ...
              <div className="col-span-full py-20 text-center bg-zinc-50/50 dark:bg-zinc-900/50 rounded-[2.5rem] border-2 border-dashed border-zinc-200 dark:border-zinc-800">
                 ...
                 <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">{L("MealPlannerAPI", "NoLikedRecipes")}</h3>
                 <p className="text-zinc-500 mb-6">{L("MealPlannerAPI", "NoLikedRecipesDesc")}</p>
                 <Button variant="outline" onClick={() => router.push("/recipe")} className="rounded-xl px-8 font-bold transition-all border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 active:scale-95">
